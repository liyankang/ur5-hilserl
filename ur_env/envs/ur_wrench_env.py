...
from ur_env.camera.multi_video_capture import MultiVideoCapture
...
class urWrenchEnv(gym.Env):
    def __init__(
        ...
        # TODO: Pass reset pose from config to ur server and avoid hardcoding 
